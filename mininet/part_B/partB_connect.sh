...
$ofctl add-flow R1 \
    in_port=1,ip,nw_src=10.1.1.17,nw_dst=10.1.1.14,actions=mod_dl_src:0A:00:00:00:00:02,mod_dl_dst:00:0B:00:00:00:02,mod_nw_src:10.4.4.14,mod_nw_dst:10.4.4.48,output=2
$ofctl add-flow S2 \
...
$ofctl add-flow R1 \
    in_port=2,ip,nw_src=10.4.4.48,nw_dst=10.1.1.14,actions=mod_dl_src:0A:00:00:00:00:01,mod_dl_dst:00:0A:00:00:00:02,mod_nw_src:10.1.1.14,mod_nw_dst:10.1.1.17,output=1
$ofctl add-flow S1 \
...
$ofctl add-flow R2 \
    in_port=1,ip,nw_src=10.4.4.96,nw_dst=10.4.4.28,actions=mod_dl_src:0B:00:00:00:00:02,mod_dl_dst:00:0C:00:00:00:02,mod_nw_src:10.6.6.46,mod_nw_dst:10.6.6.69,output=2
$ofctl add-flow S3 \
...
$ofctl add-flow R2 \
    in_port=2,ip,nw_src=10.6.6.69,nw_dst=10.6.6.46,actions=mod_dl_src:0B:00:00:00:00:01,mod_dl_dst:00:0B:00:00:00:03,mod_nw_src:10.4.4.28,mod_nw_dst:10.4.4.96,output=1
$ofctl add-flow S2 \
